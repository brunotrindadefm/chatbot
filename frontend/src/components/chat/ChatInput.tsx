...
export const ChatInput = ({ onSendMessage }: IChatInputProps) => {
    ...
    return (
        <form className="md:w-[65%] w-full p-4 bg-gray-900 border-t border-gray-700 flex flex-col items-center justify-center gap-2" onSubmit={handleSendText}>
            ...
            <h5 className="text-center text-[13px]">O BTBot pode cometer erros. Considere verificar informações importantes.</h5>
        </form>
    )
}